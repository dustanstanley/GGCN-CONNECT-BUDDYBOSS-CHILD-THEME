...
if ( is_user_logged_in() ) {
	$base_url = bp_loggedin_user_domain();
	$add_event_url = $base_url."events/my-events/edit/?action=edit#";
	$profile_events_url = $base_url."events/";
}
?>
	<p>This is a list of all events on the CONNECT site. To add a personal event or an event for a CONNECT Group, <a href="<?php echo $add_event_url; ?>">click here</a>. <br /><br />To see a list of all the events you have created and/or are attending, <a href="<?php echo $profile_events_url; ?>">click here</a>.
